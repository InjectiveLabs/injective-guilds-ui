export default {
  howItWorks: {
    ...
    descriptionThree:
      'There is no additional fees paid by the Guild Members, who only have to pay the trading fee. Meanwhile, Guild Masters will receive 40% of the trading fees generated from trades placed in their guilds.',
